...
/* Welcome Banner */
.dash-welcome {
    background: linear-gradient(135deg, #1a6b3a 0%, #0d3320 60%, #0d47a1 100%);
    border-radius: 16px;
    padding: 28px 32px;
    margin-bottom: 28px;
    display: flex;
...
.stat-card.c-total::after  { background: #1a6b3a; }
...
.stat-icon.s-total    { background: #eff6ff; color: #1a6b3a; }
...
.action-btn:hover {
    background: linear-gradient(135deg, #1a6b3a, #1565c0);
    color: #fff;
