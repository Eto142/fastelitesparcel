...
<head>
    ...
    <style>
        ...
        .stat-icon.shipments { background: rgba(26, 107, 58, 0.1); color: var(--primary); }
        ...
        .status-delivered { background: #1a6b3a; color: #ffffff; }
...
<body>
    ...
    <div class="admin-mobile-topbar" id="admin-mobile-topbar">
        ...
        <span class="mobile-logo">fastelitesparcels Admin</span>
    </div>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            <a class="navbar-brand" href="/">
                <img src="{{ asset('assets/images/logo.svg') }}" alt="fastelitesparcel" style="max-height:44px;width:auto;">
            </a>
        </div>
