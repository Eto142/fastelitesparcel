...
.wz-step-item.active .wz-circle { background:var(--primary,#1a6b3a); color:#fff; box-shadow:0 4px 14px rgba(11,61,145,.3); }
...
.wz-step-item.active .wz-label { color:var(--primary,#1a6b3a); }
...
.drop-zone:hover,.drop-zone.drag-over { border-color:var(--primary,#1a6b3a); background:#f0f9f4; }
.notif-toggle-card { display:flex; align-items:flex-start; gap:14px; background:#f0f9f4; border:1px solid #c7d9f8; border-radius:12px; padding:16px 18px; }
