...
<head>
    ...
    <meta name="description" content="fastelitesparcel Company Limited – Shipment Tracking">
    ...
    <style>
        /* ======================================================
           fastelitesparcel — TRACKING PAGE DESIGN SYSTEM
        ====================================================== */
        :root {
            --primary:        #B01E16;
            --primary-mid:    #8C1510;
...
<div class="track-topbar no-print">
    ...
    <div class="container">
        <div class="track-topbar-inner">
            <a href="{{ url('/') }}" class="track-logo" aria-label="fastelitesparcel Home">
                <img src="{{ asset('wp-content/uploads/2022/04/Screenshot_20231009_092214.png') }}"
                     alt="fastelitesparcel Company Limited">
            </a>
...
<footer class="track-footer no-print">
    <div class="container">
        ...
        <div class="footer-bottom">
            <span>&copy; {{ date('Y') }} fastelitesparcel Company Limited.</span>
