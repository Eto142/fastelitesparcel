...
<head>
    ...
    <style>
        ...
        h2 { margin: 5px 0; color: #1a6b3a; font-size: 18px; }
        .section { margin-bottom: 15px; }
        h4 { margin: 0 0 8px 0; color: #1a6b3a; border-bottom: 2px solid #1a6b3a; padding-bottom: 3px; font-size: 12px; }
        ...
        .tracking-box { background: #f0f4f8; padding: 10px; border: 1px dashed #1a6b3a; text-align: center; margin-bottom: 20px; }
        .tracking-no { font-size: 16px; font-weight: bold; color: #1a6b3a; }
    </style>
</head>
<body>
...
<div class="footer">
    <p>© {{ date('Y') }} fastelitesparcel Logistics. All rights reserved.</p>
